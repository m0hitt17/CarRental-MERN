    ...
    transition = {{duration:0.8,delay:0.2}}
        ...
        <div className=' flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8 '>
            ...
            <div className='flex flex-col items-start gap-2 '>
                ...
                <input value={pickupDate} onChange={e=>setPickupDate(e.target.value)} required type='date' id='pickup-date' min={ new Date().toISOString().split('T')[0]}className='text-sm text-gray-500 '/>
            </div>
            <div className='flex flex-col items-start gap-2 '>
                <label htmlFor='return-date'> Return Date</label>
                <input value={returnDate} onChange={e=>setReturnDate(e.target.value)} required type='date' id='return-date'className='text-sm text-gray-500 '/>
            </div>
