    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        transition={{duration:0.5}}
            src={car.image}
            className='w-full max-w-2xl mx-auto h-auto md:max-h-[400px] object-contain rounded-xl mb-6 shadow-md'
            alt={car.brand}
          />
          <motion.div 
          initial={{opacity:0}}
        ...
        transition={{duration:0.4}}
                 key={idx} className='flex flex-col items-center bg-light p-4 rounded-lg '>
